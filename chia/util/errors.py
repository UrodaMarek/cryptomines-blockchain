...
class Err(Enum):
    ...
    # ETH Errors
    INVALID_BLOCK_HASH = 142
    INVALID_PARENT_HASH = 143
    INVALID_PREV_RANDAO = 144
    INVALID_BLOCK_NUMBER = 145
    INVALID_EXTRA_DATA_SIZE = 146
    INVALID_WITHDRAWALS_COUNT = 147
    INVALID_WITHDRAWAL_INDEX = 148
    INVALID_WITHDRAWAL_VALIDATOR_INDEX = 149
    INVALID_WITHDRAWAL_ADDRESS = 150
    INVALID_WITHDRAWAL_AMOUNT = 151
    INVALID_EXECUTION_PAYLOAD_PRESENCE = 152
